...
```
https://www.ebay.com/sh/research?marketplace=EBAY-US&keywords={キーワード（URLエンコード）}&dayRange=90&startDate={start}&endDate={now}&categoryId=0&offset=0&limit=50&tabName=SOLD&tz=Asia%2FTokyo
```

### 6ヶ月間URL

```
https://www.ebay.com/sh/research?marketplace=EBAY-US&keywords={キーワード（URLエンコード）}&dayRange=180&startDate={start}&endDate={now}&categoryId=0&offset=0&limit=50&tabName=SOLD&tz=Asia%2FTokyo
```
